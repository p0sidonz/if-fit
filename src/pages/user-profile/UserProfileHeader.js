...
const UserProfileHeader = () => {
  ...
  const [data, setData] = useState({
    ...
    profileImg: 'https://demos.pixinvent.com/materialize-nextjs-admin-template/demo-1/images/avatars/1.png',
    designationIcon: 'mdi:fountain-pen-tip',
    coverImg: 'https://demos.pixinvent.com/materialize-nextjs-admin-template/demo-1/images/pages/profile-banner.png'
  })
  // useEffect(() => {
